//This is a simple unit converter program written in C
#include <stdio.h>
...
int main() {
  ...
  int currencyChoice;
  int massChoice;
  int userinputFahreinheit; // User inputted Fahreinheit;
  int userinputCelsius; // User inputted Celsius;
  ...
  if(category == 'T'){
      ...
      if(tempChoice == 1){
          ...
          scanf("%d",&userinputFahreinheit);
          fahrenheitToCelcius =  ((userinputFahreinheit-32) * (5.0/9.0));
          printf("Celcius: %d",fahrenheitToCelcius);
      }
      else if(tempChoice == 2){
        printf("Please enter the Celcius degree: \n");
        scanf("%d",&userinputCelsius);
        celciusToFahrenheit = ((9.0/5.0)*userinputCelsius + 32);
